    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
                ...
                if(rs.next())
                {
                    ...
                    ad.Info.append("Venue is :"+Decrypt(rs.getString("Venue"))+"\n");
                    ad.Info.append("Date is :"+rs.getDate("Date_Of_Event")+"\n");
                    ad.Info.append("Info being :"+Decrypt(rs.getString("Info"))+"\n");
                    ad.Prev.setEnabled(false);
